                    ...
                    <div class="profile-card">
                        <div class="card-body">
                            ...
                            <form action="changepassword" method="post">
                                <input type="hidden" class="form-control" id="accountId" name="accountId" value="${sessionScope.user.getId()}" readonly="">
                                <div class="form-group">
                                    <label for="password"><i class="fas fa-lock icon"></i>Old Password:</label>
                                    <input type="password" class="form-control" id="password" name="OldPassword" required="">
                                </div>
                                <div class="form-group">
                                    <label for="password"><i class="fas fa-lock icon"></i>New Password:</label>
                                    <input type="password" class="form-control" id="password" name="NewPassword" required="">
                                </div>
                                <div class="form-group">
                                    <label for="password"><i class="fas fa-lock icon"></i>Confirm New Password:</label>
